...
try {
    ...
    redirect(BASE_URL . '/artwork-system/designer/final-projects.php');
} catch (Throwable $e) {
    error_log('Artwork final projects bridge error: ' . $e->getMessage());
    setFlash('error', 'Artwork Final Projects is temporarily unavailable. Please contact admin.');
