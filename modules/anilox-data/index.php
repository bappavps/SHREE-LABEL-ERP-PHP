...
.module-table{border:2px solid #1e3a8a;border-radius:10px;overflow:hidden;border-collapse:separate;border-spacing:0;min-width:980px;width:max-content}
...
@media (max-width:900px){.form-grid-2{grid-template-columns:repeat(2,minmax(0,1fr))}.modal-form-section{grid-template-columns:repeat(2,minmax(0,1fr))}}
@media (max-width:768px){.qf{display:grid;grid-template-columns:1fr;margin:8px 0 10px}.qf-item{min-width:auto}.qf-actions{padding-top:10px;width:100%}.qf-reset{width:100%;justify-content:center}.module-actions{flex-direction:column;align-items:stretch}.module-btn{width:100%;justify-content:center}.modal-card{width:90%;max-width:500px;max-height:95vh}.form-grid-2{grid-template-columns:1fr;padding:10px}.anilox-summary{gap:8px}.anilox-summary .sum-card{min-width:auto;padding:8px 12px;font-size:.75rem}}
@media (max-width:640px){.form-grid-2{grid-template-columns:1fr;padding:8px;gap:8px}.modal-form-section{grid-template-columns:1fr;gap:8px}.modal-body-pad{padding:10px 14px}.modal-head{padding:10px 14px}.modal-form-label{font-size:.6rem;margin-bottom:3px}.modal-form-input{height:36px;font-size:.7rem}.qf{padding:8px;gap:6px;margin:6px 0 8px}.qf-item{gap:2px}.qf-item label{font-size:.55rem}.qf-item input,.qf-item select{height:32px;padding:0 8px;font-size:.7rem}.module-table{min-width:900px}.module-table thead th{padding:7px 10px;font-size:.7rem}.module-table tbody td{padding:7px 10px;font-size:.72rem}.col-filter-btn{font-size:8px}.qf-popup,.cfp{width:90vw;max-width:280px}.anilox-summary .sum-card{font-size:.7rem;padding:6px 10px}}
@media (max-width:360px){.card{border-radius:10px}.card-header{padding:7px 8px}.card-title{font-size:.78rem}.module-actions{gap:6px}.module-btn{padding:6px 8px;font-size:.66rem;gap:4px}.qf{padding:6px;gap:5px;margin:5px 0 7px}.qf-item label{font-size:.5rem;letter-spacing:.04em}.qf-item input,.qf-item select{height:30px;padding:0 6px;font-size:.66rem}.qf-reset{height:32px;font-size:.66rem;padding:0 10px}.module-table{min-width:820px}.module-table thead th{padding:6px 8px;font-size:.64rem}.module-table tbody td{padding:6px 8px;font-size:.66rem}.anilox-summary{gap:6px}.anilox-summary .sum-card{padding:6px 8px}.anilox-summary .sum-card .sum-label{font-size:.56rem}.anilox-summary .sum-card .sum-value{font-size:1.2rem}.modal-head{padding:8px 10px}.modal-body-pad{padding:8px 10px}.modal-form-label{font-size:.55rem}.modal-form-input{height:34px;font-size:.66rem}.qf-popup,.cfp{max-width:260px}}
