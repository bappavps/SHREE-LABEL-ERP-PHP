...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if ($action === 'reset_test_data') {
    ...
    try {
      ...
      $runResetQuery($db, "SET FOREIGN_KEY_CHECKS=1", 'Enable FK checks');
    } catch (Throwable $e) {
