...
@media (max-width:640px){.barcode-die-table{min-width:900px;font-size:.7rem}.barcode-die-table thead th{padding:4px 2px}.barcode-die-table tbody td{padding:4px 2px}.ps-quick-filter{padding:8px;gap:6px;margin:6px 0 8px}.ps-qf-item{gap:2px}.ps-qf-item label{font-size:.55rem}.ps-qf-item input,.ps-qf-item select{height:32px;padding:0 8px;font-size:.7rem}.die-calc-box{padding:8px;margin-top:6px}.die-calc-title{font-size:.7rem;margin-bottom:6px}.die-calc-grid{grid-template-columns:1fr;gap:8px}.die-calc-grid select,.die-calc-grid input{height:34px;padding:0 8px;font-size:.75rem}.modal-form-section{grid-template-columns:1fr}.modal-body-pad{padding:10px 14px}.modal-head{padding:10px 14px}.modal-form-label{font-size:.6rem;margin-bottom:3px}.modal-form-input{height:36px;font-size:.7rem}.barcode-btn{padding:6px 10px;font-size:.7rem}.col-filter-btn{font-size:8px}.ps-qf-popup,.cfp{width:90vw;max-width:280px}.card-header{padding:8px 10px}}
@media (max-width:360px){.card{border-radius:10px}.card-header{padding:7px 8px}.card-title{font-size:.78rem}.barcode-actions{gap:6px}.barcode-btn{padding:6px 8px;font-size:.66rem;gap:4px}.ps-quick-filter{padding:6px;gap:5px;margin:5px 0 7px}.ps-qf-item label{font-size:.5rem;letter-spacing:.04em}.ps-qf-item input,.ps-qf-item select{height:30px;padding:0 6px;font-size:.66rem}.ps-qf-reset{height:32px;font-size:.66rem;padding:0 10px}.barcode-die-table{min-width:820px}.barcode-die-table thead th{padding:3px 2px;font-size:.62rem}.barcode-die-table tbody td{padding:3px 2px;font-size:.64rem}.die-calc-box{padding:7px}.die-calc-title{font-size:.66rem}.die-calc-grid select,.die-calc-grid input{height:32px;font-size:.68rem}.modal-head{padding:8px 10px}.modal-body-pad{padding:8px 10px}.modal-form-label{font-size:.55rem}.modal-form-input{height:34px;font-size:.66rem}.ps-qf-popup,.cfp{max-width:260px}}
