...
$errors = [];
$data = ['name'=>'','code'=>'','category_id'=>'','description'=>'','unit'=>'PCS','size'=>'','material'=>'','price'=>'','stock'=>0,'min_stock'=>0];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        $stmt = $conn->prepare("INSERT INTO products (name,code,category_id,description,unit,size,material,price,stock,min_stock) VALUES (?,?,?,?,?,?,?,?,?,?)");
        $stmt->bind_param('ssissssdii',
...
<div class="d-flex align-items-center justify-content-between mb-4">
    <h4 class="fw-bold mb-0"><i class="fas fa-plus me-2 text-primary"></i>Add Product / Label</h4>
        ...
        <form method="POST">
            <div class="row g-3">
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" name="size" class="form-control" value="<?php echo sanitize($data['size']); ?>" placeholder="e.g. 50x30mm">
                </div>
                <div class="col-md-3">
                    <label class="form-label fw-semibold">Material</label>
                    <input type="text" name="material" class="form-control" value="<?php echo sanitize($data['material']); ?>" placeholder="e.g. Paper, PVC">
                </div>
                <div class="col-md-3">
