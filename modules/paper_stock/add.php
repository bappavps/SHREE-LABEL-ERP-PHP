...
// Combined list: active master entries + all distinct values already in paper_stock.
$companyOptions = getMasterPaperCompanies(true);
$typeOptions    = getMasterPaperTypes(true);

// Merge with existing paper_stock values so old names remain selectable
    ...
    <div class="card-body">
      <div class="form-grid">
        ...
        <div class="form-group">
          ...
          <span class="form-hint">Type to search — select from master or existing stock values.</span>
        </div>
        <div class="form-group">
