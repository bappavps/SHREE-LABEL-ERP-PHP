...
function erp_print_studio_durba_special_label_elements(): array {
    return [
        [
            'id' => 'durba-title',
            'type' => 'text',
        ...
        [
            ...
            'height' => 13,
            'rotate' => 0,
            'content' => 'Batch: {{label_batch_no}} | Job: {{label_job_no}}',
            'placeholder' => '',
            'isLocked' => false,
            'style' => [
                'fontSize' => 10,
        ...
        [
            ...
            'height' => 14,
            'rotate' => 0,
            'content' => 'Size: {{label_size}} | W: {{item_width}} mm | L: {{item_length}} mm',
            'placeholder' => '',
            'isLocked' => false,
            'style' => [
                'fontSize' => 10,
        ...
        [
            ...
            'height' => 16,
            'rotate' => 0,
            'content' => 'Carton: {{rolls_per_carton}} | Per Roll: {{pcs_per_roll}} | Total Pcs: {{total_pcs_per_carton}}',
            'placeholder' => '',
            'isLocked' => false,
            'style' => [
                'fontSize' => 12,
...
function erp_print_studio_system_template_specs(): array {
    ...
    return [
        ...
        [
            'name' => 'DURBA SPECIAL LABEL',
            'aliases' => ['DURBA SPECIAL LABEL'],
            'document_type' => 'Packing Label',
            'paper_width' => 150,
            'paper_height' => 100,
            'elements' => erp_print_studio_durba_special_label_elements(),
            'background' => $background,
            'is_default' => 0,
        ],
    ];
