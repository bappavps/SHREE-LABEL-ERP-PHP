...
$query = "SELECT p.*, f.id AS latest_file_id, f.filename, f.original_name, f.uploaded_at 
        ...
        <?php foreach ($projects as $project): ?>
            <div class="project-card" onclick="window.location.href='<?php echo BASE_URL; ?>/designer/project-details.php?id=<?php echo $project['id']; ?>'" style="cursor: pointer;">
                <div class="project-thumb">
                    ...
                    <?php else: ?>
                        <i class="fas <?php echo getFileIcon($ext); ?>" style="font-size: 3.5rem; color: #cbd5e1;"></i>
                    <?php endif; ?>
                ...
                <div class="project-info">
                    ...
                    <div class="project-meta">
                        ...
                        <?php
                            $commentCount = $db->prepare("SELECT COUNT(*) FROM artwork_comments c JOIN artwork_files f ON c.file_id = f.id WHERE f.project_id = ?");
