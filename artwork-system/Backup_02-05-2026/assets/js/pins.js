document.addEventListener('DOMContentLoaded', function () {
    ...
    function getRelativePosition(clientX, clientY) {
        ...
        const x = ((clientX - rect.left) / scale) / wrapper.clientWidth * 100;
        const y = ((clientY - rect.top) / scale) / wrapper.clientHeight * 100;
    ...
    function reloadWithViewState() { saveViewState(); window.location.reload(); }
